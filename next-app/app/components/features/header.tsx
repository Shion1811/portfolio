...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 md:px-20 sm:px-0 sm:h-[110px] h-[80px] py-3 mx-auto z-50 bg-beige border-b-[0.3px] border-white w-full px-2">
      <div className="flex items-center justify-between gap-2">
        <div className="underline sm:w-[25%] h-fit sm:px-2 px-0 py-1 text-center w-[60%]  mx-auto">
          <button
            className="title text-black w-fit h-full font-family-title"
            onClick={() => router.push("/")}
          >
            Suzuki Shion
          </button>
